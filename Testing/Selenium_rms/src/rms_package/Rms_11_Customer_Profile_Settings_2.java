...
public class Rms_11_Customer_Profile_Settings_2 {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		Thread.sleep(500);
		driver.findElement(By.xpath("//*[@id=\'root\']/div/div[2]/div/div/div/div[3]/button")).click();
		driver.findElement(By.xpath("/html/body/div[2]/div[3]/div/div/input")).sendKeys("Jilani");
