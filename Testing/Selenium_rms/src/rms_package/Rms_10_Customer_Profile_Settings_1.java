...
public class Rms_10_Customer_Profile_Settings_1 {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		Thread.sleep(500);
		driver.findElement(By.xpath("//*[@id=\'root\']/div/div[2]/div/div/div/div[2]/button\r\n")).click();
		driver.findElement(By.xpath("/html/body/div[2]/div[3]/div/div/input")).sendKeys("khizer");
		Thread.sleep(500);
